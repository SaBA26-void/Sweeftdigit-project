...
<div class="container mt-4">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="/Sweeftdigit-project/?page=books&action=store" method="POST">
                <div class="row">
                    <div class="col-md-8">
                        <div class="mb-3">
                ...
                <div class="mb-3">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <div>
                            <a href="/Sweeftdigit-project/?page=authors&action=create&return_to=<?php echo urlencode('/Sweeftdigit-project/?page=books&action=create'); ?>" target="_blank" class="btn btn-sm btn-outline-primary me-2">
                    ...
                    <div class="form-control" style="min-height: 150px; max-height: 200px; overflow-y: auto;">
                        ...
                        <?php else: ?>
                            <div class="text-center text-muted py-3">
                                ...
                                <p>No authors found. <a href="/Sweeftdigit-project/?page=authors&action=create&return_to=<?php echo urlencode('/Sweeftdigit-project/?page=books&action=create'); ?>" target="_blank">Add the first author</a>.</p>
                            </div>
                        <?php endif; ?>
                    </div>
...
<script>
    window.addEventListener('load', function() {
        ...
        if (urlParams.get('refresh') === 'authors') {
            const newUrl = window.location.pathname + window.location.search.replace(/[?&]refresh=authors/, '');
            window.history.replaceState({}, document.title, newUrl);
        }
    });

    document.addEventListener('DOMContentLoaded', function() {
        const authorCount = document.querySelectorAll('input[name="authors[]"]').length;
        if (authorCount === 0) {
